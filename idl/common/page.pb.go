...
func (x *PageModel) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PageModel) ProtoMessage() {}

func (x *PageModel) ProtoReflect() protoreflect.Message {
	mi := &file_page_proto_msgTypes[0]
...
// Deprecated: Use PageModel.ProtoReflect.Descriptor instead.
func (*PageModel) Descriptor() ([]byte, []int) {
	return file_page_proto_rawDescGZIP(), []int{0}
}

func (x *PageModel) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *PageModel) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *PageModel) GetTotalRows() int64 {
	if x != nil {
		return x.TotalRows
	}
	return 0
...
func (x *PageModel) GetTotalPages() int64 {
	if x != nil {
		return x.TotalPages
	}
	return 0
...
var file_page_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x70, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x61, 0x67, 0x65, 0x22, 0x79, 0x0a, 0x09, 0x50, 0x61, 0x67,
	0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x61, 0x67, 0x65, 0x18, 0x01,
	...
	0x61, 0x67, 0x65, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x73, 0x69, 0x6d, 0x2f, 0x69, 0x64, 0x6c, 0x2f,
...
var file_page_proto_goTypes = []interface{}{
	(*PageModel)(nil), // 0: common.page.PageModel
}
